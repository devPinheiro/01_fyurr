...
from models import db_setup, Venue, Show, Artist, db
import sys
import pytz
...
def search_venues():
    ...
    if(len(term) < 1):
        flash('please enter a search query with at least two characters !')
